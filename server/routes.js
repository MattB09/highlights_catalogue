...
const { addTag, addAuthor, addBook } = require("./controller");
const { editTag, editAuthor, editBook } = require("./controller");
const { deleteTag, deleteAuthor, deleteBook } = require("./controller");
const routes = Router();
